    ...
    <>
        ...
        >
          ...
          <Link to="/register">
            <Button
              ...
              marginTop={'10'}
              p="7"
              css={{":hover":{backgroundColor:"#38A169",color:"white"}}}
            >
          ...
          >
            ...
            >
              ...
              <Text
                ...
                textAlign={'justify'}
              >
                Welcome to the 11-year-old legacy of JECRC MUN, established in
                2012 by like–minded individuals aiming to create a society for
                youth to discuss, debate, and deliberate present-day crises
                while experiencing themselves standing in the shoe of various
                world leaders. JECRC MUN, the foremost host of the Model UN
                Conference in Jaipur was inaugurated by the eminent educationist
                Shri Kulbhushan Kothari.With together efforts of our
                enthusiastic and extensive organizing committees over 11 years
                of conducting Model UN conferences, we have arisen as one of the
                best and most promising Model UN societies in India.
              </Text>
            ...
            >
              <Image
                width={['85%', '80%']}
                src={intro}
                boxShadow="0px 0px 32px rgba(0, 0, 0, 0.6)"
              />
            </VStack>
          </Stack>
          ...
          >
            <VStack alignItems={['center', 'flex-end']} width={['100%', '50%']}>
              ...
              <Text
                ...
                textAlign={'justify'}
              >
                Someone wise once said it is better to debate a question without
                settling it than to settle a question without debate.
                <br />
                JECRC MUN is immensely scornful to announce another triumphant
                event that once again raised their benchmark across the state,
                Zero Hour Submit 2.0 The event was organized in JECRC College on
                the 3rd of December 2022 by JECRC Model UN; a student-driven
                debating event that is a "360-minute battle of opinion" for
                campus students, who aspired to overcome their dread of public
                speaking.
              </Text>
            ...
            <Stack>
              <CardBody p={['15px', '50px']}>
                ...
                <Text py="2" fontSize={['15px', '20px']} textAlign={'justify'}>
                  Urgent discussions on gun control, and enforcement of measures
                  intended to restrict the possession and the use of firearms.
                </Text>
              </CardBody>
            </Stack>
          </Card>
            ...
            <Stack>
              <CardBody p={['15px', '50px']}>
                ...
                <Text py="2" fontSize={['15px', '20px']}>
                  Deliberation on Union Budget, 2023 with special emphasis on
          ...
          >
            ...
            <Stack>
              <CardBody p={['15px', '50px']}>
                ...
                <Text py="2" fontSize={['15px', '20px']} textAlign={'justify'}>
                  Protecting victims of human trafficking in conflict and
                  post-conflict situations. (Special emphasis on women and
                  children)
                </Text>
              </CardBody>
            </Stack>
          ...
          >
            ...
            <Stack>
              <CardBody p={['15px', '50px']}>
                ...
                <Text py="2" fontSize={['15px', '20px']} textAlign="justify">
                  Addressing all forms of discrimination against people
                  belonging to marginalized sexual orientations & gender
                  identities.
                </Text>
              </CardBody>
            </Stack>
      ...
      >
        ...
        >
          ...
          >
            <Card size={'md'} width={['100%', '80%']} justifySelf={'center'}>
              <CardHeader>
                <Flex spacing="4">
                  <Flex flex="1" gap="4" alignItems="center" flexWrap="wrap">
                    <Avatar name="Segun Adebayo" src={shrey} size={'2xl'} />
                    <Box>
              ...
              <CardBody>
                <Text textAlign="justify" fontSize="17px">
                  The JECRC Model United Nations Conference 2022 was a unique
                  and impactful event that left a lasting impression on me. The
                  emphasis on inclusivity and diversity created an atmosphere of
                  respect and mutual understanding, while the engaging agendas
                  challenged me to think beyond traditional solutions. The
                  conference provided me with practical skills such as public
                  speaking, negotiation, and critical thinking, which I believe
                  will be invaluable in my future endeavors. The opportunity to
                  collaborate with like-minded individuals from around the world
                  was also a highlight of the conference. Overall, I would
                  highly recommend the JECRC MUN to anyone looking to expand
                  their horizons, develop practical skills, and make a positive
                  impact on the world
                </Text>
              </CardBody>
            </Card>
            <Card size="md" width={['100%', '80%']} justifySelf={'center'}>
              <CardHeader>
                <Flex spacing="4">
                  <Flex flex="1" gap="4" alignItems="center" flexWrap="wrap">
                    <Avatar name="Segun Adebayo" src={sarthak} size={'2xl'} />
                    <Box>
                      <Heading
                        size="lg"
                        fontWeight={'semibold'}
              ...
              <CardBody>
                <Text fontSize="17px">
                  The JECRC Model United Nations Conference was an unforgettable
                  experience. The conference provided me with a platform to
                  discuss and debate complex global issues with a diverse group
                  of individuals. The opportunity to interact with people from
                  different backgrounds and cultures allowed me to broaden my
                  perspective and gain a deeper understanding of the world
                  around me. The event was expertly organized, with engaging
                  agendas and thought-provoking discussions. I was impressed by
                  the professionalism and dedication of the organizers, who
                  worked tirelessly to ensure that every participant had a
                  rewarding experience. Overall, the JECRC MUN Conference was a
                  highly valuable and enriching experience that I would highly
                  recommend to anyone interested in global affairs and diplomacy
                </Text>
              </CardBody>
            </Card>
            <Card size="md" width={['100%', '80%']} justifySelf={'center'}>
              <CardHeader>
                <Flex spacing="4">
                  <Flex flex="1" gap="4" alignItems="center" flexWrap="wrap">
                    <Avatar name="Segun Adebayo" src={saloni} size={'2xl'} />
                    <Box>
                      <Heading
                        size="lg"
                        fontWeight={'semibold'}
              ...
              <CardBody>
                <Text fontSize={'17px'}>
                  The JECRC MUN Conference 2022 was a conference unlike any
                  other I have ever attended. The organizers did an outstanding
                  job of creating an environment that fostered intellectual
                  curiosity, collaboration, and diplomacy. The agendas were
                  thought-provoking, and the discussions were engaging,
                  challenging me to think critically about global issues. What
                  made the conference truly unique, however, was the networking
                  opportunities it provided. I was able to meet and network with
                  fellow delegates from all over the country, and the
                  conversations we had were insightful and inspiring. I learned
                  so much from the diverse range of perspectives and experiences
                  shared by my fellow delegates, and the connections I made will
                  undoubtedly last a lifetime. The organization of the
                  conference was also impressive, and the organizers went out of
                  their way to ensure that every delegate had a positive and
                  rewarding experience. Overall, I would highly recommend the
                  JECRC Model UN Conference to anyone looking to expand their
                  knowledge, network with like-minded individuals, and gain
            ...
            <Card size="md" width={['100%', '80%']} justifySelf={'center'}>
              <CardHeader>
                <Flex spacing="4">
                  <Flex flex="1" gap="4" alignItems="center" flexWrap="wrap">
                    <Avatar name="Segun Adebayo" src={rishit} size={'2xl'} />
                    <Box>
                      <Heading
                        size="lg"
                        textTransform={'uppercase'}
              ...
              <CardBody>
                <Text fontSize={'17px'}>
                  JECRC MUN is an excellent opportunity for students who want to
                  enhance their knowledge of international relations, diplomacy,
                  and public speaking. The conference provides a stimulating and
                  challenging environment that encourages delegates to reach
                  their full potential, and I would highly recommend it to
                  anyone looking for an enriching MUN experience.
                </Text>
              </CardBody>
            </Card>
          </SimpleGrid>
              ...
              Speaker.map(Speakers => {
                ...
                return (
                  <Box textAlign="center" my={'10'}>
                    ...
                    <Box>
                      <Text fontStyle={'italic'}>{desc}</Text>
                    </Box>
                  </Box>
                );
              })}
